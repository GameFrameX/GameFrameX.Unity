...
namespace Hotfix.Config.test
{
    public partial class TbCompositeJsonTable2 : BaseDataTable<test.CompositeJsonTable2>
    {
        ...
        public TbCompositeJsonTable2(System.Func<System.Threading.Tasks.Task<JSONNode>> loadFunc)
        {
            _loadFunc = loadFunc;
        ...
        public override async System.Threading.Tasks.Task LoadAsync()
        {
            ...
            foreach(JSONNode _ele in _json.Children)
            {
                ...
                { if(!_ele.IsObject) { throw new SerializationException(); }  _v = test.CompositeJsonTable2.DeserializeCompositeJsonTable2(_ele);  }
                DataList.Add(_v);                
