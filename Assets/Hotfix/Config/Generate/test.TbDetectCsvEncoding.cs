...
namespace Hotfix.Config.test
{
    public partial class TbDetectCsvEncoding : BaseDataTable<test.DetectEncoding>
    {
        ...
        public TbDetectCsvEncoding(System.Func<System.Threading.Tasks.Task<JSONNode>> loadFunc)
        {
            _loadFunc = loadFunc;
        ...
        public override async System.Threading.Tasks.Task LoadAsync()
        {
            ...
            foreach(JSONNode _ele in _json.Children)
            {
                ...
                { if(!_ele.IsObject) { throw new SerializationException(); }  _v = test.DetectEncoding.DeserializeDetectEncoding(_ele);  }
                DataList.Add(_v);                
